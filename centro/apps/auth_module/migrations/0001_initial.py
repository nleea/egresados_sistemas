# Generated by Django 4.1.2 on 2022-10-21 00:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(default=True)),
                ('resources', models.ManyToManyField(related_name='roles_resources', through='auth_module.Resources_roles', to='auth_module.resources')),
            ],
            options={
                'verbose_name': 'Roles',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updateAt', models.DateField(auto_now=True, null=True)),
                ('status', models.BooleanField(default=True)),
                ('rolesId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='roles', to='auth_module.roles')),
        ...
        migrations.AddField(
            model_name='roles',
            name='users',
            field=models.ManyToManyField(related_name='roles_user', through='auth_module.User_roles', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='resources_roles',
            name='rolesId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='resouces_roles', to='auth_module.roles'),
        ),
        migrations.AddField(
            model_name='resources',
            name='roles',
            field=models.ManyToManyField(related_name='resources_roles', through='auth_module.Resources_roles', to='auth_module.roles'),
        ),
        migrations.CreateModel(
            name='Persons',
            fields=[
                ...
                ('status', models.BooleanField(default=True)),
                ('document_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='document_types', to='auth_module.document_types')),
        ...
        migrations.AddField(
            model_name='user',
            name='roles',
            field=models.ManyToManyField(related_name='user_roles', through='auth_module.User_roles', to='auth_module.roles'),
        ),
        migrations.AddField(
            model_name='user',
