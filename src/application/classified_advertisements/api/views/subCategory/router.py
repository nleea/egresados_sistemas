...
from src.interfaces.routes.classified.sub_category_route import router
from src.application.classified_advertisements.models import SubCategoria


class Router(SimpleRouter):
    router_base = router
    name_base = "sub-categoria"
    model = SubCategoria
