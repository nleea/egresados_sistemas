...
from src.interfaces.routes.classified.capacitaciones_route import router
from src.application.classified_advertisements.models import TiposCapacitaciones
