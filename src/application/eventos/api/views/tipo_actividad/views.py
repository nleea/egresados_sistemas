from src.application.eventos.api.serializers.eventos.eventos_tipo import (
    TipoEventosSerializersView,
    TipoEventosSerializers,
)
...
class TipoViewSet(ViewSet):
    ...
    def get_serializer_class(self):
        if self.action == "get":
            return TipoEventosSerializersView
        return TipoEventosSerializers
