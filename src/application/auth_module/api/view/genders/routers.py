...
from src.interfaces.routes.auth_module.gender_route import gender_router
from src.application.auth_module.models import Genders


class GenderRouter(SimpleRouter):
    router_base = gender_router
    name_base = "genders"
    model = Genders
