...
from apps.classified_advertisements.api.views.advertisement.router import Router
from apps.classified_advertisements.api.views.advertisement.views import (
