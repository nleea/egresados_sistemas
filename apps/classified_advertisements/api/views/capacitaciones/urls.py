...
from apps.classified_advertisements.api.views.capacitaciones.router import Router
from apps.classified_advertisements.api.views.capacitaciones.view import (
